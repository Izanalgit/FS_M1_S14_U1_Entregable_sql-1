...
-- Tu respuesta aquí
SELECT COUNT(nombre) AS numUsers FROM usuarios_lenguajes
...
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE lenguaje LIKE 'JavaScript'
...
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes AS NoHayJAJA WHERE lenguaje LIKE 'Java' AND edad < 25
...
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE lenguaje IS NULL
...
-- Tu respuesta aquí
SELECT COUNT(nombre) AS numUsers FROM usuarios_lenguajes WHERE edad > 28
...
-- Tu respuesta aquí
SELECT COUNT(nombre) AS numUsers ,lenguaje FROM usuarios_lenguajes GROUP BY lenguaje ORDER BY numUsers DESC LIMIT 1

-- Ejercicio 15: Seleccionar el usuario  mayor de 25 y que sepa el lenguaje 'TypeScript'.
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE edad > 25 AND lenguaje LIKE 'TypeScript'
...
-- Tu respuesta aquí
SELECT nombre , COUNT(lenguaje) as lenguajes FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL GROUP BY nombre
...
-- Tu respuesta aquí
SELECT CONCAT(nombre , " "  ,apellido) AS nombre FROM usuarios_lenguajes
...
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE edad IN (SELECT edad FROM usuarios_lenguajes GROUP BY edad HAVING count(nombre) > 1) 
...
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE lenguaje LIKE 'J%' ORDER BY LENGTH(lenguaje) ASC LIMIT 1

-- Ejercicio 30: Encontrar el usuario con edad mayor a 30 y que sabe el lenguaje con menos caracteres.
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE edad > 30 ORDER BY LENGTH(lenguaje) ASC LIMIT 1

-- Ejercicio 31: Seleccionar los usuarios que saben al menos un lenguaje y ordenarlos por nombre de lenguaje. 
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL ORDER BY lenguaje
...
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE lenguaje != 'SQL'
...
-- Tu respuesta aquí
SELECT nombre, ABS(edad - edades.media) as diferencia FROM usuarios_lenguajes , ( SELECT AVG(edad) as media FROM usuarios_lenguajes) edades
